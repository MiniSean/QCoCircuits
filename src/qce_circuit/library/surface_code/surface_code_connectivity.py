...
class Surface17Round4ZXXZCode(GenericSurfaceCode, IGenericSurfaceCodeLayer, metaclass=SingletonABCMeta):
...
class Surface17Round8BCode(GenericSurfaceCode, IGenericSurfaceCodeLayer, metaclass=SingletonABCMeta):
...
class Surface17Round8CCode(GenericSurfaceCode, IGenericSurfaceCodeLayer, metaclass=SingletonABCMeta):
...
class Surface13ERound4Code(GenericSurfaceCode, IGenericSurfaceCodeLayer, metaclass=SingletonABCMeta):
...
class Surface13FRound4Code(GenericSurfaceCode, IGenericSurfaceCodeLayer, metaclass=SingletonABCMeta):
...
if __name__ == '__main__':
    ...
    # )
    plot_stabilizer_specific_gate_sequences(
        description=Surface17Round8CCode(),
    )
    plt.show()
