...
class StimFactoryManager(IStimCircuitFactory, metaclass=SingletonABCMeta):
    ...
    _factory: IStimCircuitFactory = StimCircuitFactoryManager(
        factory_lookup={
            ...
            Rx90: NameBasedOperationsFactory('SQRT_X'),
            Rxm90: NameBasedOperationsFactory('SQRT_X_DAG'),
            Ry180: NameBasedOperationsFactory('Y'),
            Ry90: NameBasedOperationsFactory('SQRT_Y'),
            Rym90: NameBasedOperationsFactory('SQRT_Y_DAG'),
